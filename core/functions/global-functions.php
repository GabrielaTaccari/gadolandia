...
function show_error_page($error_code = '404') {
    ...
    $error_file = ABS_PATH . '/error_pages/';
...
function captcha_response($chave) {
    require_once(ABS_PATH . '/externo/recaptcha/src/ReCaptcha/ReCaptcha.php');
    require_once(ABS_PATH . '/externo/recaptcha/src/ReCaptcha/RequestMethod.php');
    require_once(ABS_PATH . '/externo/recaptcha/src/ReCaptcha/RequestParameters.php');
    require_once(ABS_PATH . '/externo/recaptcha/src/ReCaptcha/Response.php');
    require_once(ABS_PATH . '/externo/recaptcha/src/ReCaptcha/RequestMethod/Post.php');
    require_once(ABS_PATH . '/externo/recaptcha/src/ReCaptcha/RequestMethod/Socket.php');
    require_once(ABS_PATH . '/externo/recaptcha/src/ReCaptcha/RequestMethod/SocketPost.php');
...
function globals($key = null, $value = null, $mode = 'set') {
    ...
    if (!file_exists(ABS_PATH . "/var/globals.data")) {
        file_put_contents(ABS_PATH . "/var/globals.data", "");
    }

    if (filesize(ABS_PATH . "/var/globals.data") == 0) {
        $_file = array();
    } else {
        $_file = file_get_contents(ABS_PATH . "/var/globals.data");
    ...
    switch ($mode) {
        case 'set':
            $_file[$key] = $value;
            file_put_contents(ABS_PATH . "/var/globals.data", serialize($_file));
            break;
